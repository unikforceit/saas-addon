...
function magnews_orderby_post(){
    return array(
        'none' => __('No order', 'saasdoctorelement'),
        'ID' => __('Post ID', 'saasdoctorelement'),
        'author' => __('Author', 'saasdoctorelement'),
        'title' => __('Title', 'saasdoctorelement'),
        'date' => __('Published date', 'saasdoctorelement'),
        'modified' => __('Modified date', 'saasdoctorelement'),
        'parent' => __('By parent', 'saasdoctorelement'),
        'rand' => __('Random order', 'saasdoctorelement'),
        'comment_count' => __('Comment count', 'saasdoctorelement'),
        'menu_order' => __('Menu order', 'saasdoctorelement'),
        'post__in' => __('By include order', 'saasdoctorelement'),
    );  
}
...
function madmag_ft_images($thumbnail){
    ...
    $placeholder =  SaaS_PLUGIN_URL . 'assets/lazyload.svg';
...
function saasdoctor_get_category_link($taxonomy){
...
function misha_loadmore_ajax_handler(){
    ...
    require SaaS_PLUGIN_DIR.'includes/loops/'. $template .'.php';
    die(); 
}
...
function misha_tabcat_ajax_handler(){
    ...
    //require(SaaS_PLUGIN_DIR.'includes/loops/tabcat.php');
    require SaaS_PLUGIN_DIR.'includes/loops/'. $template .'.php';
    die(); 
}
